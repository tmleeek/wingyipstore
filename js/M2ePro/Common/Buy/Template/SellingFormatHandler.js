...
CommonBuyTemplateSellingFormatHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    qty_mode_change: function()
    {
        ...
        $('qty_max_posted_value_mode').value = M2ePro.php.constant('Ess_M2ePro_Model_Buy_Template_SellingFormat::QTY_MAX_POSTED_MODE_OFF');
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Buy_Template_SellingFormat::QTY_MODE_PRODUCT') ||
            ...
            $('qty_max_posted_value_mode').value = M2ePro.php.constant('Ess_M2ePro_Model_Buy_Template_SellingFormat::QTY_MAX_POSTED_MODE_ON');
    ...
    qtyMaxPostedMode_change: function()
    {
        ...
        if (this.value == M2ePro.php.constant('Ess_M2ePro_Model_Buy_Template_SellingFormat::QTY_MAX_POSTED_MODE_ON')) {
