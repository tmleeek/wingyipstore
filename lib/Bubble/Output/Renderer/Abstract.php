...
abstract class Bubble_Output_Renderer_Abstract
{
    ...
    public function start($str, $indent = false)
    {
        return $this->output($str, $indent, false, false);
    }
    ...
    final protected function _echo($str, $indent = false, $exit = false, $eol = true)
    {
        ...
        if (!empty($this->_callback)) {
            call_user_func($this->_callback, $echo);
        }
    ...
    public function registerCallback($class, $method)
    {
