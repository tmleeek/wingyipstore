...
class Ess_M2ePro_Model_Play_Item extends Ess_M2ePro_Model_Component_Abstract
{
    /**
    ...
    public function getAccount()
    {
        if (is_null($this->accountModel)) {
            $this->accountModel = Mage::helper('M2ePro/Component_Play')->getCachedObject(
    ...
    public function getMarketplace()
    {
        if (is_null($this->marketplaceModel)) {
            $this->marketplaceModel = Mage::helper('M2ePro/Component_Play')->getCachedObject(
