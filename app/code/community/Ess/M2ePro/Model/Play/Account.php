...
class Ess_M2ePro_Model_Play_Account extends Ess_M2ePro_Model_Component_Child_Play_Abstract
{
    const PANEL_MODE_TRADE   = 'trade';
    const PANEL_MODE_TOOLBOX = 'toolbox';
    ...
    public function deleteInstance()
    {
        ...
        $items = $this->getRelatedSimpleItems('Play_Item','account_id',true);
    ...
    public function getPanelMode()
    {
        return $this->getData('panel_mode');
    }

    public function isPanelModeToolbox()
    {
        return $this->getPanelMode() == self::PANEL_MODE_TOOLBOX;
    }

    public function isPanelModeTrade()
    {
        return $this->getPanelMode() == self::PANEL_MODE_TRADE;
    }
    ...
    public function getListingsUpdateLinksSettings()
    {
        return $this->getData('listings_update_links_settings');
    }

    public function getDecodedListingsUpdateLinksSettings()
    {
        $tempData = $this->getListingsUpdateLinksSettings();
