...
class Ess_M2ePro_Model_Connector_Play_Dispatcher
{
    //####################################
     ...
     * @return Ess_M2ePro_Model_Connector_Play_Requester|Ess_M2ePro_Model_Connector_Play_Abstract
     */
    ...
    {
        $className = empty($ormPrefixToConnector) ? 'Ess_M2ePro_Model_Connector_Play' : $ormPrefixToConnector;
