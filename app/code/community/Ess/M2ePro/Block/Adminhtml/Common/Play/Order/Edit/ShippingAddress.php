...
class Ess_M2ePro_Block_Adminhtml_Common_Play_Order_Edit_ShippingAddress
    extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('playOrderEditShippingAddress');
        $this->_blockGroup = 'M2ePro';
        $this->_controller = 'adminhtml_common_play_order_edit';
