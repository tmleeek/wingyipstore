...
class Ess_M2ePro_Block_Adminhtml_Common_Play_Listing_ProductSearch_Menu extends Mage_Adminhtml_Block_Widget_Container
{
    public function __construct()
    {
        parent::__construct();

        $this->setTemplate('M2ePro/common/play/listing/product_search/menu.phtml');
    }
