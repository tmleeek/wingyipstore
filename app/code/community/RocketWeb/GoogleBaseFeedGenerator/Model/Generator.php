...
class RocketWeb_GoogleBaseFeedGenerator_Model_Generator extends Varien_Object {
    ...
    protected function _getCollection() {
        ...
        $collection->addAttributeToFilter('status', array('neq' => Mage_Catalog_Model_Product_Status::STATUS_DISABLED))
                    ->addFieldToFilter('visibility', array('in' => array(Mage_Catalog_Model_Product_Visibility::VISIBILITY_BOTH,
                                                                         Mage_Catalog_Model_Product_Visibility::VISIBILITY_IN_CATALOG)));

//        // For configurables, bundles, grouped - minimal price, .. => doesn't select out of stock products.
//        $product_types = $this->getConfig()->getMultipleSelectVar('product_types', $this->getData('store_id'));
//        $minimal_price_type = array(Mage_Catalog_Model_Product_Type::TYPE_BUNDLE, Mage_Catalog_Model_Product_Type::TYPE_CONFIGURABLE, Mage_Catalog_Model_Product_Type::TYPE_GROUPED);
