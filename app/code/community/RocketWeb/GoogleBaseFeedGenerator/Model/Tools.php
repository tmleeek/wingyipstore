...
//            }
     ...
     * @return array
     */
    protected function getConfigurableAttributesAsArray($product) {

        $attributeCodes = $this->getConfigurableAttributeCodes($this->getProduct()->getId(), true);

        $res = array();
        foreach ($attributeCodes as $code) {
            $res[] = $this->getConfigurableAttribute($code);
        }
        return $res;
    }
}
