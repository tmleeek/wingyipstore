    ...
    function addMediaFile($type = "", $source = "", $before = false, $params = null, $if = "", $cond = "") {
     ...
     public function loadMedia(){
        if ( !defined("_LOAD_JQUERY_") ) {
            $this->addMediaFile("js", "venustheme/ves_verticalmenu/jquery/jquery-1.7.1.min.js");
             $this->addMediaFile("js", "venustheme/ves_verticalmenu/jquery/conflict.js");
            define( "_LOAD_JQUERY_",1 );
        }
        $this->addMediaFile("js", "venustheme/ves_verticalmenu/jquery/ui/jquery-ui-1.8.16.custom.min.js");
        $this->addMediaFile("js", "venustheme/ves_verticalmenu/jquery/tabs.js");
        $this->addMediaFile("js", "venustheme/ves_verticalmenu/jquery/jquerycookie.js");
        $this->addMediaFile("js", "venustheme/ves_verticalmenu/admin/verticalmenu/jquery.nestable.js");
