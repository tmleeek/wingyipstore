 ...
 */
class Ves_Verticalmenu_Block_System_Config_Form_Field_Notification extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$jspath = $url.'venustheme/ves_verticalmenu/form/script.js';
		$csspath = $url.'venustheme/ves_verticalmenu/form/style.css';
