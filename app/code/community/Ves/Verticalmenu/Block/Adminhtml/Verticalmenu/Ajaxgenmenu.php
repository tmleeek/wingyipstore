...
?>
<?php
class Ves_Verticalmenu_Block_Adminhtml_Verticalmenu_Ajaxgenmenu extends Mage_Adminhtml_Block_Widget_Form_Container
{
    var $treemenu = null;
    /**
     *
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('ves_verticalmenu/verticalmenu/verticalmenu_tree.phtml');
    ...
    public function getTree( $parent=1 , $edit=false, $params, $store_id = 0 ) {
        ...
        if($parent == 1 || empty($parent)) {
            $parent = 1;
            $childs = Mage::getModel('ves_verticalmenu/verticalmenu')->getChilds( $parent, $store_id );
