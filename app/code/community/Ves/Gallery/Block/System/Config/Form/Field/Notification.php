...
class Ves_Gallery_Block_System_Config_Form_Field_Notification extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$jspath = $url.'ves_gallery/form/script.js';
		$csspath = $url.'ves_gallery/form/style.css';
