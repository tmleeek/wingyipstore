...
class Ves_Gallery_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('ves_gallery/banner_image'));
     ...
     *
     * @see ves_gallery_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return ves_gallery_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return ves_gallery_Model_Banner_Image
     */
