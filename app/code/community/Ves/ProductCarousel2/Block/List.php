...
class Ves_ProductCarousel2_Block_List extends Mage_Catalog_Block_Product_Abstract 
{
	 ...
	 * @return string
	 */
	function getConfig( $key, $panel='ves_productcarousel2' ){
	...
	function getProductByCategory(){
		...
		$products = Mage::getModel('catalog/product')
			...
			->addAttributeToSelect('*')
			->addAttributeToFilter('category_id', array('in' => $catsid));
		$products->getSelect()->order(new Zend_Db_Expr('RAND()'))->limit($limit+40);
