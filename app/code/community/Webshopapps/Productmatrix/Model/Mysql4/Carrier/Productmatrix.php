...
class Webshopapps_Productmatrix_Model_Mysql4_Carrier_Productmatrix extends Mage_Core_Model_Mysql4_Abstract
{
                                ...
                                if ($usingZones && $this->_uDrop) {
                                    ...
                                    foreach ($splitZones as $zone) {
                                        ...
                                        $data[] = array('website_id' => $websiteId, 'dest_country_id' => $zone,
                                                        ...
                                                        'delivery_type' => $csvLine[$zoneOffset+12], 'notes' => $csvLine[$zoneOffset+13],'delivery_method' => $csvLine[$zoneOffset+14],'shipping_sku' => $csvLine[$zoneOffset+15]);
                                    }
                                                ...
                                                foreach ($splitCities as $city) {
                                                    ...
                                                    if ($this->_uDrop && !count($exceptions)) {
                                                        $data[] = array('website_id' => $websiteId, 'dest_country_id' => $countryId, 'dest_region_id' => $regionId,
                                                            ...
                                                            'delivery_type' => $csvLine[15 + $offset], 'notes' => $csvLine[16 + $offset],'delivery_method' => $csvLine[17 + $offset],'shipping_sku'=> $csvLine[18 + $offset]);
                                                        ...
                                                        $data[] = array('website_id' => $websiteId, 'dest_country_id' => $countryId, 'dest_region_id' => $regionId,
                                                            ...
                                                            'delivery_type' => $csvLine[17 + $offset], 'notes' => $csvLine[18 + $offset],'delivery_method' => $csvLine[19 + $offset],'shipping_sku'=> $csvLine[20 + $offset]);
                                                        ...
                                                        $data[] = array('website_id' => $websiteId, 'dest_country_id' => $countryId, 'dest_region_id' => $regionId,
                                                            ...
                                                            'item_from_value' => $item_from, 'item_to_value' => $item_to,
                                                            'customer_group' => $customer_group,
                                                            'price' => $csvLine[13], 'algorithm' => $csvLine[14], 'delivery_type' => $csvLine[15], 'notes' => $csvLine[16],'delivery_method' => $csvLine[17],'shipping_sku'=> $csvLine[18]);
                                                    }
    ...
    {
        if ($csvCount < 13 || $csvCount > 19 && !$this->_uDrop && !$this->_volume) {
