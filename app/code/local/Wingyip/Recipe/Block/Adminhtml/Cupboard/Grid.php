<?php
class Wingyip_Recipe_Block_Adminhtml_Cupboard_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('cupboardGrid');
        // This is the primary key of the database
        $this->setDefaultSort('recipe_cupboard_id');
    ...
    {
        $collection = Mage::getModel('recipe/cupboard')->getCollection();
    ...
    {
        $this->setMassactionIdField('recipe_cupboard_id');
        $this->getMassactionBlock()->setFormFieldName('recipe_cupboard_id');
