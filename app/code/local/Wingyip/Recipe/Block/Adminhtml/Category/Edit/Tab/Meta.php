...
class Wingyip_Recipe_Block_Adminhtml_Category_Edit_Tab_Meta extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		$fieldset = $form->addFieldset('category_form', array('legend'=>Mage::helper('recipe')->__('Category Meta Information')));
