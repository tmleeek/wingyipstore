<?php
class Wingyip_Recipe_Block_Adminhtml_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        $this->setDefaultSort('recipe_category_id');
    ...
    {
        $collection = Mage::getModel('recipe/category')->getCollection();
    ...
    {
        $this->setMassactionIdField('recipe_category_id');
        $this->getMassactionBlock()->setFormFieldName('recipe_category_id');
        ...
        'url'  => $this->getUrl('*/*/massUpdateCategoryUrl', array('' => '')),
        'confirm' => Mage::helper('recipe')->__('Are you sure?')
        ));
