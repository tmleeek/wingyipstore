<?php
class Wingyip_Recipe_Block_Homelist extends Wingyip_Recipe_Block_List{
    ...
    protected function getCollection()
    {
        ...
        if (is_null($this->_collection)) {
            ...
            /* $this->_collection->getSelect()->columns(array("name"=>"main_table.name","description"=>"main_table.description","sort"=>"main_table.sort"));
