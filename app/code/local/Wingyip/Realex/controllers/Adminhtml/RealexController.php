...
class Wingyip_Realex_Adminhtml_RealexController extends Mage_Adminhtml_Controller_action
{

    protected function _initTransaction(){
        $txn = Mage::getModel('realex/realex')->load(
	...
	public function viewAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->_addContent($this->getLayout()->createBlock('realex/adminhtml_realex_view'))
				->_addLeft($this->getLayout()->createBlock('realex/adminhtml_realex_view_tabs'));
