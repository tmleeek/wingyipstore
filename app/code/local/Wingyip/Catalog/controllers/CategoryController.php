...
class Wingyip_Catalog_CategoryController extends Mage_Catalog_CategoryController
{
    protected function _initCatagory()
    {
        //Check Session Compare Product
        $isValid = Mage::getSingleton('catalog/session')->getValid();
        if($isValid == "true"){
            Mage::getSingleton('catalog/session')->unsSuccess();
        }
