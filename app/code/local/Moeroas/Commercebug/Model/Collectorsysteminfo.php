...
*/
class Moeroas_Commercebug_Model_Collectorsysteminfo extends Moeroas_Commercebug_Model_Observingcollector
{
    protected $_items;
    ...
    public function createAjaxUrl($action)
    {
        ...
        #Moeroas_Commercebug_Model_Shim::Log('Mage2 Cleanup in ' . __CLASS__ . ' ' . __LINE__);
