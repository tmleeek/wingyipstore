...
*/
abstract class Moeroas_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Moeroas_Commercebug_AjaxController','Moeroas_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Moeroas_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
