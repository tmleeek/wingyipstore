...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Moeroas_Commercebug><active>true</active><codePool>local</codePool></Moeroas_Commercebug></modules></config>';
        $string = str_replace('Moeroas_', $this->namespace . '_',$string);
