...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    public function queueNewOrderEmail($forceMode = false)
    {
        ...
        if (strpos($this->getShippingMethod(),'productmatrix') !== false) {
            $new_description = str_replace(Mage::getStoreConfig('carriers/productmatrix/title').' - ','',$this->getShippingDescription());
            $this->setShippingDescription($new_description);
            $this->save();
        }
